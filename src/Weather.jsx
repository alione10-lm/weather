    ...
    <div className="flex flex-col items-center  gap-4 ">
      <header className="z-50 bg-[url('/hero.jpeg')]  bg-no-repeat bg-cover bg-center w-full h-56 rounded-md flex flex-col items-center">
        <input
          ...
          type="text"
          placeholder="search..."
          className="text-indigo-500 bg-transparent backdrop-blur-xl rounded-lg border-none  focus:outline-none focus:ring-2 focus:ring-indigo-500 px-4  transition-all placeholder:text-indigo-500 duration-300 py-2 my-4"
        />
        {Country && (
